...
<h1 align="center"><b><i>Welcome to Target3 of Room number 5</h2>
<style>
h1 {font-family: cosmic sans ms,sans-serif;
font-size: 26pt; color: aquamarine};                                          
</style>                                                         
<?php                                                                         
$value = system("cat /sys/class/gpio/gpio130/value");            
if ($value == 1)                                                              
{                                                                
echo '                                                                        
<h2 align="center">                                              
<b>                                                              
<i>The Target3 of Room number 5 is in ON state</h>               
<style>                                              
...
<h2 align="center">                                        
<b>                                                              
<i>The Target3 of Room number 5 is in OFF state</h>        
<style>             
