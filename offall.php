...
<h2 align="center"><b><i>All the targets in 
your Home are now turned OFF           
</h2>           
</td>                                                               
</tr>              
</table>                                                                      
...
system("echo 0 > /sys/kernel/debug/omap_mux/sdmmc2_dat3");                    
...
system("echo 0 > /sys/class/gpio/gpio158/value");
...
system("echo 0 > /sys/class/gpio/gpio161/value");        
...
system("echo 0 > /sys/class/gpio/gpio159/value");  
...
system("echo 0 > /sys/class/gpio/gpio183/value"); 
